...
/**
 * T58-9-0: GET /api/trees/:treeId/evidence - List evidence for a tree
 */
export async function GET(
    ...
    try {
        ...
        const response = await fetch(`${apiTarget}/api/trees/${treeId}/evidence`, {
            method: 'GET',
            headers,
        });
        ...
        console.error(`Error proxying GET /api/trees/${treeId}/evidence:`, error);
