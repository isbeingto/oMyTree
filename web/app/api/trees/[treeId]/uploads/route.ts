...
/**
 * T85: GET /api/trees/:treeId/uploads - List uploads for a tree
 */
export async function GET(
    ...
    try {
        ...
        const response = await fetch(`${apiTarget}/api/trees/${treeId}/uploads`, {
            method: 'GET',
            headers,
        });
        ...
        console.error(`Error proxying GET /api/trees/${treeId}/uploads:`, error);
