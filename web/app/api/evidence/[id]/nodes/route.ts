...
/**
 * T58-9-0: GET /api/evidence/:id/nodes - Get nodes attached to evidence
 */
export async function GET(
    ...
    try {
        ...
        const response = await fetch(`${apiTarget}/api/evidence/${id}/nodes`, {
            method: 'GET',
            headers,
        });
        ...
        console.error(`Error proxying GET /api/evidence/${id}/nodes:`, error);
