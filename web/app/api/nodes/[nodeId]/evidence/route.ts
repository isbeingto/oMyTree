...
/**
 * T58-9-0: GET /api/nodes/:nodeId/evidence - Get evidence attached to a node
 */
export async function GET(
    ...
    try {
        ...
        const response = await fetch(`${apiTarget}/api/nodes/${nodeId}/evidence`, {
            method: 'GET',
            headers,
        });
        ...
        console.error(`Error proxying GET /api/nodes/${nodeId}/evidence:`, error);
