...
var apiKeySecret = func() []byte {
	// WeKnora uses AES keys for API key encryption/decryption.
	// In ops, it's common to store 32-byte keys as 64-char hex strings.
	// Support both raw bytes (16/24/32 chars) and hex (32/48/64 chars).
